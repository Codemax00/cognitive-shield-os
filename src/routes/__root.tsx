...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cognitive OS for sustained focus and discipline." },
      { property: "og:title", content: "FocusGuard Cognitive OS" },
      { property: "og:description", content: "Prevent passive consumption. Anchor your discipline." },
